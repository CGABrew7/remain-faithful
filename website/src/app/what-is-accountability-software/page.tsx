        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-5">
              {[
                ...
                },
                {
                  ...
                  pros: 'Screenshots, OCR text, and raw screen content never leave the device. Classification happens entirely on-device using local AI models. Partners may receive a short system-generated summary in addition to category, severity, and timestamp — not screenshots. No battery penalty from VPN. Coverage is limited to non-DRM frames the user opts to scan — not every app, and not DRM video.',
          ...
          <section className="mb-14" id="choosing">
            ...
            <div className="space-y-4">
              {[
                { q: '1. Which platforms do you and your partner use?', a: 'If you need cross-platform coverage (Windows, Mac, Android), your options are Covenant Eyes, Ever Accountable, and Accountable2You. Remain Faithful is available for iPhone (iOS 17+); Android is planned.' },
                { q: '2. What should your partner actually receive?', a: 'Screenshot tools send actual screenshots of flagged content, exposing partners to harmful material. Remain Faithful may send a short system-generated summary in addition to category, severity, and timestamp — not screenshots, OCR text, or raw content — protecting partners from exposure while still creating accountability.' },
          ...
          <section className="mb-14" id="faq">
            ...
            <div className="space-y-4">
              {[
                ...
                { q: 'Is accountability software legal?', a: 'Yes, when used by consenting adults 18+ on their own devices for peer accountability. Using accountability software on another adult\'s device without their knowledge or consent would raise serious legal and ethical concerns. All reputable accountability software requires the monitored person to install and enable the software themselves. Monitoring should always be consensual for adults.' },
