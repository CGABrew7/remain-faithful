        ...
        <div className="prose-content space-y-12">
          <Section title="Our Commitment">
            ...
            <p>
              ...
              <a href="mailto:privacy@remainfaithful.com" className="text-[#C9A84C] hover:underline">
                privacy@remainfaithful.com
              </a>.
            </p>
          </Section>
          ...
          <Section title="Your Rights">
            ...
            <ul>
              <li><strong className="text-[#F0EDE8]">Access your data:</strong> request a full export of your account data via Settings → Export My Data, or by emailing privacy@remainfaithful.com</li>
          ...
          <Section title="Children">
            <p>
              Remain Faithful is not intended for users under the age of 18. We do not knowingly collect data from anyone under 18. If you believe we have inadvertently collected data from a minor, contact us immediately at privacy@remainfaithful.com and we will delete it promptly.
            </p>
          </Section>
          ...
          <Section title="Contact">
            <p>
              Remain Faithful<br />
              Email: <a href="mailto:privacy@remainfaithful.com" className="text-[#C9A84C] hover:underline">privacy@remainfaithful.com</a><br />
