    ...
    <>
      ...
      <section className="pt-8 pb-20 border-b border-hairline">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-wax text-sm font-semibold uppercase tracking-widest mb-4">Our Story</p>
            ...
            <div className="rounded-sm p-8" style={{ boxShadow: 'var(--shadow-border)' }}>
              ...
              <p className="text-sm text-ink-soft mt-4">Jeff Brewer, Founder</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-paper-deep border-b border-hairline">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-wax text-sm font-semibold uppercase tracking-widest mb-3">The Founder</p>
          ...
          <div className="max-w-3xl mx-auto space-y-6 text-ink-soft leading-relaxed">
            ...
            <div className="rounded-sm p-8 text-center my-8" style={{ boxShadow: 'var(--shadow-border)' }}>
            ...
            <div className="flex items-center gap-4 pt-2">
              <div className="w-12 h-12 rounded-sm bg-wax flex items-center justify-center text-paper font-bold">
                JB
              </div>
              <div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h2 className="font-serif text-2xl font-bold text-ink mb-5">Why We Built This</h2>
            ...
            <div>
              <h2 className="font-serif text-2xl font-bold text-ink mb-5">Mission &amp; Vision</h2>
              <div className="space-y-5">
                <div className="p-5 rounded-sm border border-hairline bg-paper-deep">
                  <h3 className="font-semibold text-wax mb-2 text-sm uppercase tracking-wide">Mission</h3>
                ...
                <div className="p-5 rounded-sm border border-hairline bg-paper-deep">
                  <h3 className="font-semibold text-wax mb-2 text-sm uppercase tracking-wide">Vision</h3>
                  <p className="text-sm text-ink-soft leading-relaxed">
      ...
      <section className="py-20 bg-paper-deep border-y border-hairline">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-serif text-3xl font-bold text-ink mb-4">What We Stand For</h2>
          </div>
          <div className="grid sm:grid-cols-2 gap-5">
            {[
              ...
              <div key={v.title} className="p-6 rounded-sm border border-hairline bg-paper-deep">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-serif text-2xl font-bold text-ink mb-5">Open Source Commitment</h2>
              <p className="text-ink-soft leading-relaxed mb-4">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-sm border border-wax/30 bg-wax/10 text-wax text-sm font-semibold hover:bg-wax/20 transition-colors"
                >
      ...
      <section className="py-20 bg-paper-deep border-y border-hairline">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-serif text-3xl font-bold text-ink mb-5">Why Donations, Not Subscriptions</h2>
          ...
          <div className="grid sm:grid-cols-3 gap-4 text-left mb-10">
            {[
              ...
              <div key={c.label} className="p-5 rounded-sm border border-hairline bg-paper-deep">
                <p className="text-xs text-ink-soft uppercase tracking-wide mb-1">{c.label}</p>
                <p className="font-serif font-bold text-wax text-xl mb-1">{c.amount}</p>
      ...
      <section id="contact" className="py-20">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-serif text-3xl font-bold text-ink mb-4">Get in Touch</h2>
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 text-center sm:text-left">
            <div className="flex-1 p-5 rounded-sm border border-hairline bg-paper-deep">
              <p className="text-xs text-ink-soft uppercase tracking-wide mb-1">Email</p>
              <a href="mailto:support@remainfaithful.com" className="text-wax text-sm hover:underline">
                support@remainfaithful.com
              </a>
            </div>
            <div className="flex-1 p-5 rounded-sm border border-hairline bg-paper-deep">
              <p className="text-xs text-ink-soft uppercase tracking-wide mb-1">Bug Reports</p>
              <a
                href={GITHUB_URL}
                target="_blank"
                rel="noopener noreferrer"
                className="text-wax text-sm hover:underline"
              >
                GitHub Issues
              </a>
            </div>
